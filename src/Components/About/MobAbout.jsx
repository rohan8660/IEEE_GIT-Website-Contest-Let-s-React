...
function TabAbout(props) {
  ...
  return (
    <Grid container className={styles.root}>
      <Grid item >
        <Typography variant="h6" className={styles.subHeadings}>Overview on IEEE</Typography>
      ...
      <Grid item >
        <Typography variant="h6" className={styles.subHeadings}>History of IEEE-GIT</Typography>
